<?php /*a:4:{s:63:"/www/wwwroot/nitai4.xfwl.club/app/admin/view/website/index.html";i:1655628674;s:60:"/www/wwwroot/nitai4.xfwl.club/app/admin/view/public/nav.html";i:1655573114;s:63:"/www/wwwroot/nitai4.xfwl.club/app/admin/view/public/header.html";i:1655573114;s:63:"/www/wwwroot/nitai4.xfwl.club/app/admin/view/public/footer.html";i:1655573114;}*/ ?>
<!--
拟态UI4.0个人主页设计
博客：www.xfwl.club
作者：小枫
...
<head>
    ...
    <title>旗下站点 - <?php echo htmlentities($system['sitename']); ?>后台管理系统</title>
...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="card xf_mimic_outer">
                            <div class="card-header">
                                <h4 style="color: var(--primary); font-size: 1.8em; font-weight: 700;">添加站点</h4>
                            </div>
                            <div class="card-body">

                                <form  action="<?php echo url('admin/website/forms'); ?>" method="post">
                                    <div class="form-group">
                                        <label for="example-website-name" style="font-size: 1.3em;">网站名称</label>
                                        <input class="form-control" type="text" id="example-website-name"
                                            name="name" placeholder="请输入你的站点名称" value="小枫网络">
                                        <small class="help-block">站点名称</small>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-website-links" style="font-size: 1.3em;">网站链接</label>
                                        <input class="form-control" type="text" id="example-website-links"
                                            name="url" placeholder="请输入你的网站链接"
                                            value="http://www.xfwl.club"
                                            onkeyup="value=value.replace(/[^\%\%\0-9\$]/g,'')" maxlength="4">
                                        <small class="help-block">例如：http://www.xfwl.club</small>
                                    </div>
                                    <div class="form-group">
    ...
    <script type="text/javascript">
        function OpenDel(id){
            if (confirm("确定要删除吗？")) {
                $.post("<?php echo url('admin/website/del'); ?>",{id : id},function(ret){
                    if(ret.status == 200){
                        alert(ret.msg);
