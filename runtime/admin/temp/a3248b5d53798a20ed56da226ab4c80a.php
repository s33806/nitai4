                                ...
                                <div class="tab-pane active">
                                    <form action="<?php echo url('admin/basic/forms'); ?>" enctype="multipart/form-data" method="post" class="edit-form">
                                        <div class="form-group">
                                            <label for="web_site_title" class="title_font">网站主标题</label>
                                            ...
                                            <small class="help-block">这个是主标题</small>
                                        </div>
                                        <div class="form-group">
                                            <label for="web_site_title_2" class="title_font">网站副标题</label>
                                        ...
                                        <!--<div class="form-group">
                                            <label for="web_qq_group" class="title_font">QQ群</label>
                                            <input class="form-control" type="text" id="web_qq_group" name="qq_group" value="<?php echo htmlentities($system['qq_group']); ?>" placeholder="QQ群">
                                        </div>
                                        <div class="form-group">
                                            <label for="web_author" class="title_font">作者</label>
                                            <input class="form-control" type="text" id="web_author" name="author" value="<?php echo htmlentities($system['author']); ?>" placeholder="QQ群">
                                        </div>-->
                                        <div class="form-group">
