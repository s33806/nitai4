<?php /*a:1:{s:59:"/www/wwwroot/cs.api-yun.top/app/admin/view/login/index.html";i:1655481259;}*/ ?>
<!--
拟态UI4.0个人主页设计
博客：www.xfwl.club
作者：小枫
    ...
    <div class="login_core">
        ...
        <form action="<?php echo url('admin/login/forms'); ?>" method="post" class="xf_mimic_outer">
            <div class="xf_mimic_outer" data-tip="戳我干嘛~">
                <img src="<?php echo htmlentities($system['site_logo']); ?>" style="height: 120px;">
            </div>
            ...
            <p><a href="/">返回首页</a> · <?php echo htmlentities($system['sitename']); ?></p>
        </form>
    </div>
